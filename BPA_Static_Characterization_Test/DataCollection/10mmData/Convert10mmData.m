...
Data_10mm_13cm_Unkinked_Test2 = csvread('10mm_13cm_Unkinked_Test2.csv');
    ...
    Pressure_10mm_13cm_Unkinked_Test2 =Data_10mm_13cm_Unkinked_Test2(:,2);
...
Data_10mm_13cm_Unkinked_Test10 = csvread('10mm_13cm_Unkinked_Test10.csv');
    ...
    Force_10mm_13cm_Unkinked_Test10 = (((Force_10mm_13cm_Unkinked_Test10_Offset)*0.1535)-1.963)*4.45; %corrected Force output (N)/
%% Compare all valve switching dynamics
figure
    title('10mm 13cm Unkinked - Comparing valve switching dynamics')
    plot(Pressure_10mm_13cm_Unkinked_Test1,Force_10mm_13cm_Unkinked_Test1)
    hold on
    plot(Pressure_10mm_13cm_Unkinked_Test2,Force_10mm_13cm_Unkinked_Test2)
    plot(Pressure_10mm_13cm_Unkinked_Test3,Force_10mm_13cm_Unkinked_Test3)
    plot(Pressure_10mm_13cm_Unkinked_Test4,Force_10mm_13cm_Unkinked_Test4)
    plot(Pressure_10mm_13cm_Unkinked_Test5,Force_10mm_13cm_Unkinked_Test5)
    plot(Pressure_10mm_13cm_Unkinked_Test6,Force_10mm_13cm_Unkinked_Test6)
    plot(Pressure_10mm_13cm_Unkinked_Test7,Force_10mm_13cm_Unkinked_Test7)
    plot(Pressure_10mm_13cm_Unkinked_Test8,Force_10mm_13cm_Unkinked_Test8)
    plot(Pressure_10mm_13cm_Unkinked_Test9,Force_10mm_13cm_Unkinked_Test9)
    plot(Pressure_10mm_13cm_Unkinked_Test10,Force_10mm_13cm_Unkinked_Test10)
    hold off
