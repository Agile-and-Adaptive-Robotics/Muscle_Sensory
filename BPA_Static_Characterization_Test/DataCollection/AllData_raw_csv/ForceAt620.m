...
Z10P9 = Test9Data(Test9Data(:,4)==1,3);
y10P9 = imresize(Y10P9,[400 1]);
z10P9 = imresize(Z10P9,[400 1]);
Y10P10 = Test10Data(Test10Data(:,4)==1,2);
Z10P10 = Test10Data(Test10Data(:,4)==1,3);
y10P10 = imresize(Y10P10,[400 1]);
z10P10 = imresize(Z10P10,[400 1]);
z10max9 = interp1(y10P9, z10P9, 620)
z10max10 = interp1(yP10, z10P10, 620)
z10max = mean([z10max9 z10max10])
figure
hold on
...
Z15P9 = Test9Data(Test9Data(:,4)==1,3);
y15P9 = imresize(Y15P9,[400 1]);
z15P9 = imresize(Z15P9,[400 1]);
Y15P10 = Test10Data(Test10Data(:,4)==1,2);
Z15P10 = Test10Data(Test10Data(:,4)==1,3);
y15P10 = imresize(Y15P10,[400 1]);
z15P10 = imresize(Z15P10,[400 1]);
z15max9 = interp1(y15P9, z15P9, 620)
z15max10 = interp1(y15P10, z15P10, 620)
z15max = mean([z15max9 z15max10])
figure
hold on
