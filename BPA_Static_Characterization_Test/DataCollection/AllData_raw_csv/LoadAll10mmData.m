...
li = [12,11.6,11.2,10.8];
    ...
    for a = 1:length(Kinks_10mm13cm)
        for i = 8:10    
            ...
            BPA10mm13cm{i,a}(:,4) = ones(length(BPA10mm13cm{i,a}),1)*10;  %col 4 = diameter
            BPA10mm13cm{i,a}(:,5) = 13; %cut length (cm)
            BPA10mm13cm{i,a}(:,6) = ones(length(BPA10mm13cm{i,a}),1)*vals_13cm(a); %col6 = kinks
            BPA10mm13cm{i,a}(:,7) = ones(length(BPA10mm13cm{i,a}),1)*i;%col7 = Test#
            ...
            BPA10mm13cm{i,a}=imresize(BPA10mm13cm{i,a},[num 13],'nearest')
        end
    end


% Combine all 10cm 13cm data into one array
AllBPA10mm13cm =BPA10mm13cm{8};
for a =1:length(Kinks_10mm13cm)
    for i=9:10
...
Kinks_10mm23cm = {'23cm_Unkinked_Test', '23cm_Kinked14mm_Test','23cm_Kinked30mm_Test'};
    ...
    for a = 1:length(Kinks_10mm23cm)
        for i = 8:10    
            ...
            BPA10mm23cm{i,a}(:,4) = ones(length(BPA10mm23cm{i,a}),1)*10;  %col 4 = diameter
            BPA10mm23cm{i,a}(:,5) = 23;
            BPA10mm23cm{i,a}(:,6) = ones(length(BPA10mm23cm{i,a}),1)*vals_23cm(a); %col5 = kinks
            BPA10mm23cm{i,a}(:,7) = ones(length(BPA10mm23cm{i,a}),1)*i;%col6 = Test#
            ...
            BPA10mm23cm{i,a}=imresize(BPA10mm23cm{i,a},[num 13],'nearest')
        end
    end


% Combine all 10cm 23cm data into one array
AllBPA10mm23cm =BPA10mm23cm{8};
for a =1:length(Kinks_10mm23cm)
    for i=9:10
...
Kinks_10mm27cm = {'27cm_Unkinked_Test', '27cm_Kinked7mm_Test','27cm_Kinked15mm_Test','27cm_Kinked31mm_Test'};
    ...
    for a = 1:length(Kinks_10mm27cm)
        for i = 8:10    
            ...
            BPA10mm27cm{i,a}(:,4) = ones(length(BPA10mm27cm{i,a}),1)*10;  %col 4 = diameter
            BPA10mm27cm{i,a}(:,5) = 27;  %cut length
            BPA10mm27cm{i,a}(:,6) = ones(length(BPA10mm27cm{i,a}),1)*vals_27cm(a); %col5 = length kinked
            BPA10mm27cm{i,a}(:,7) = ones(length(BPA10mm27cm{i,a}),1)*i;%col6 = Test#
            ...
            BPA10mm27cm{i,a}(:,9) = lo; %resting length
            BPA10mm27cm{i,a}(:,10)= l620; %length at 620 kPa
            BPA10mm27cm{i,a}(:,11)= li(a); %current length
            BPA10mm27cm{i,a}(:,12)= (lo - li(a))./lo; %strain
            BPA10mm27cm{i,a}(:,13)= ((lo - li(a))./lo)./maxstrain_27cm; %relative strain
            BPA10mm27cm{i,a}=imresize(BPA10mm27cm{i,a},[num 13],'nearest')
        end
    end


% Combine all 10cm 27cm data into one array
AllBPA10mm27cm =BPA10mm27cm{8};
for a =1:length(Kinks_10mm27cm)
    for i=9:10
...
Kinks_10mm29cm = {'29cm_Unkinked_Test', '29cm_Kinked17mm_Test','29cm_Kinked28mm_Test','29cm_Kinked41mm_Test'};
    ...
    for a = 1:length(Kinks_10mm29cm)
        for i = 8:10    
            ...
            BPA10mm29cm{i,a}(:,4) = ones(length(BPA10mm29cm{i,a}),1)*10;  %col 4 = diameter
            BPA10mm29cm{i,a}(:,5) =29;
            BPA10mm29cm{i,a}(:,6) = ones(length(BPA10mm29cm{i,a}),1)*vals_29cm(a); %col5 = kinks
            BPA10mm29cm{i,a}(:,7) = ones(length(BPA10mm29cm{i,a}),1)*i;%col6 = Test#
            ...
            BPA10mm29cm{i,a}=imresize(BPA10mm29cm{i,a},[num 13],'nearest')
        end
    end


% Combine all 10cm 29cm data into one array
AllBPA10mm29cm =BPA10mm29cm{8};
for a =1:length(Kinks_10mm29cm)
    for i=9:10
...
Kinks_10mm30cm = {'30cm_Unkinked_Test','30cm_Kinked12mm_Test','30cm_Kinked22mm_Test','30cm_Kinked33mm_Test'}; 
    ...
    for a = 1:length(Kinks_10mm30cm)
        for i = 8:10    
            ...
            BPA10mm30cm{i,a}(:,4) = ones(length(BPA10mm30cm{i,a}),1)*10;  %col 4 = diameter
            BPA10mm30cm{i,a}(:,5) =30;
            BPA10mm30cm{i,a}(:,6) = ones(length(BPA10mm30cm{i,a}),1)*vals_30cm(a); %col5 = kinks
            BPA10mm30cm{i,a}(:,7) = ones(length(BPA10mm30cm{i,a}),1)*i%col6 = Test#
            ...
            BPA10mm30cm{i,a}=imresize(BPA10mm30cm{i,a},[num 13],'nearest')
        end
    end


% Combine all 10cm 30cm data into one array
AllBPA10mm30cm =BPA10mm30cm{8};
for a =1:length(Kinks_10mm30cm)
    for i=9:10
...
% 10mm 13cm
    figure
    subplot 121
    plot(AllBPA10mm13cm_P(:,3),AllBPA10mm13cm_P(:,1),'b.');
    xlabel('time (s)')
    ylabel('Force(N)')
...
% 10mm 23cm
    figure
    subplot 121
    plot(AllBPA10mm23cm_P(:,3),AllBPA10mm23cm_P(:,1),'bo');
    subplot 122
...
% 10mm 27cm
    figure
    subplot 121
    plot(AllBPA10mm27cm_P(:,3),AllBPA10mm27cm_P(:,1),'bo');
    subplot 122
...
%10mm 29cm
    figure
    subplot 121
    plot(AllBPA10mm29cm_P(:,3),AllBPA10mm29cm_P(:,1),'bo');
    subplot 122
...
%10mm 30cm
    figure
    subplot 121
    plot(AllBPA10mm30cm_P(:,3),AllBPA10mm30cm_P(:,1),'bo');
    subplot 122
