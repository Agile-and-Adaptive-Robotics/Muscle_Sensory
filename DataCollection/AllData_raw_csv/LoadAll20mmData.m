...
Kinks_20mm10cm = {'10cm_Unkinked_Test','10cm_Kinked13mm_Test','10cm_Kinked20mm_Test'};
    ...
    for a = 1:length(Kinks_20mm10cm)
        for i = 1:10
            ...
            idx = BPA20mm10cm{i,a}(:,3) <=27; %indexing the pressurizing part
...
AllBPA20mm10cm_P = AllBPA20mm10cm(id_P,1:8);
AllBPA20mm10cm_DP = AllBPA20mm10cm(id_DP,1:8);
...
Kinks_20mm12cm = {'12cm_Unkinked_Test','12cm_Kinked10mm_Test','12cm_Kinked20mm_Test'};
    ...
    for a = 1:length(Kinks_20mm12cm)
        for i = 1:10
            ...
            idx = BPA20mm12cm{i,a}(:,3) <=27; %indexing the pressurizing part
...
AllBPA20mm12cm_P = AllBPA20mm12cm(id_P,1:8);
AllBPA20mm12cm_DP = AllBPA20mm12cm(id_DP,1:8);
...
Kinks_20mm23cm = {'23cm_Unkinked_Test','23cm_Kinked9mm_Test','23cm_Kinked19mm_Test'};
    ...
    for a = 1:length(Kinks_20mm23cm)
        for i = 1:10
            ...
            idx = BPA20mm23cm{i,a}(:,3) <=27; %indexing the pressurizing part
...
AllBPA20mm23cm_P = AllBPA20mm23cm(id_P,1:8);
AllBPA20mm23cm_DP = AllBPA20mm23cm(id_DP,1:8);
...
Kinks_20mm30cm = {'30cm_Unkinked_Test','30cm_Kinked14mm_Test','30cm_Kinked23mm_Test','30cm_Kinked34mm_Test'};
    ...
    for a = 1:length(Kinks_20mm30cm)
        for i = 1:10
            ...
            idx = BPA20mm30cm{i,a}(:,3) <=27; %indexing the pressurizing part
...
AllBPA20mm30cm_P = AllBPA20mm30cm(id_P,1:8);
AllBPA20mm30cm_DP =AllBPA20mm30cm(id_DP,1:8);
...
Kinks_20mm40cm = {'40cm_Unkinked_Test','40cm_Kinked35mm_Test','40cm_Kinked46mm_Test','40cm_Kinked69mm_Test'};
    ...
    for a = 1:length(Kinks_20mm40cm)
        for i = 1:10
            ...
            idx = BPA20mm40cm{i,a}(:,3) <=27; %indexing the pressurizing part
...
AllBPA20mm40cm_P = AllBPA20mm40cm(id_P,1:8);
AllBPA20mm40cm_DP = AllBPA20mm40cm(id_DP,1:8);
