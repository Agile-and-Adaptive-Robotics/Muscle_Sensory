...
%             BPA10mm13cm{i,a}(:,5) = ones(length(BPA10mm13cm{i}),1)*vals_13cm(a); %col5 = kinks
%             BPA10mm13cm{i,a}(:,6) = ones(length(BPA10mm13cm{i}),1)*i%col6 = Test#
%         end
%     end
% 
% 
...
Kinks_10mm23cm = {'23cm_Unkinked_Test', '23cm_Kinked14mm_Test','23cm_Kinked30mm_Test'};
    ...
    for a = 1:length(Kinks_10mm23cm)
        for i = 1:10
            ...
            BPA10mm23cm{i,a}(:,5) = ones(length(BPA10mm23cm{i}),1)*vals_23cm(a); %col5 = kinks
            BPA10mm23cm{i,a}(:,6) = ones(length(BPA10mm23cm{i}),1)*i%col6 = Test#
        end
    end
...
Kinks_10mm27cm = {'27cm_Unkinked_Test', '27cm_Kinked7mm_Test','27cm_Kinked15mm_Test','27cm_Kinked31mm_Test'};
    ...
    for a = 1:length(Kinks_10mm27cm)
        for i = 1:10
            ...
            BPA10mm27cm{i,a}(:,5) = ones(length(BPA10mm27cm{i}),1)*vals_27cm(a); %col5 = kinks
            BPA10mm27cm{i,a}(:,6) = ones(length(BPA10mm27cm{i}),1)*i%col6 = Test#
        end
    end
...
Kinks_10mm29cm = {'29cm_Unkinked_Test', '29cm_Kinked17mm_Test','29cm_Kinked28mm_Test','29cm_Kinked41mm_Test'};
    ...
    for a = 1:length(Kinks_10mm29cm)
        for i = 1:10
            ...
            BPA10mm29cm{i,a}(:,5) = ones(length(BPA10mm29cm{i}),1)*vals_27cm(a); %col5 = kinks
            BPA10mm29cm{i,a}(:,6) = ones(length(BPA10mm29cm{i}),1)*i%col6 = Test#
        end
    end
...
Kinks_10mm30cm = {'30cm_Unkinked_Test','30cm_Kinked12mm_Test','30cm_Kinked22mm_Test','30cm_Kinked33mm_Test'}; 
    ...
    for a = 1:length(Kinks_10mm30cm)
        for i = 1:10
            ...
            BPA10mm30cm{i,a}(:,5) = ones(length(BPA10mm30cm{i}),1)*vals_27cm(a); %col5 = kinks
            BPA10mm30cm{i,a}(:,6) = ones(length(BPA10mm30cm{i}),1)*i%col6 = Test#
        end
    end
