...
volatile float rest_m_ess = 0.9207;
volatile float rest_b_ess = 3.7735;
//filter coefficients
volatile float fc1 = 0.013359200027857;
volatile float fc2 = -0.7008967811884;
volatile float fc3 = 1.64745998107697655399;
//variables for calibration; set this slope to 1 and zero intercept for this code
//this code doesn't not need the second calibration step.
volatile float vfin1_m = 1.0;
volatile float vfin1_b = 0.0;
volatile float vfin1_cal = 0.0;
/*
...
void DataLoggingLoop() //Interrupt loop
{
    ...
    vfin1_cal = vfin1_m*vfin1 + vfin1_b;

    String ISS_reading = String(vfin1_cal);
    String ESS_reading = String(vfin2);   
