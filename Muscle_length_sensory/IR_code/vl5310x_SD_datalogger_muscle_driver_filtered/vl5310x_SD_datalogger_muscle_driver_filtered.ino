...
#define SHT_ISS 24  //Internal Sensor
#define SHT_ESS 25  //External Sensor
// set up the sensor
...
void DataLoggingLoop() //Interrupt loop
{
    ...
    String ISS_reading = String(vfin1 + rest_offset_iss);
    String ESS_reading = String(vfin2 + rest_offset_ess);   
