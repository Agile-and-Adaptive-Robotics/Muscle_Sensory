...
axes[0].plot(indx1, raw1[:, 0], linewidth= 0.4, marker= ".")
axes[0].plot(indx1, raw1[:, 1], linewidth= 0.4, marker= ".")
#bottom plot, plot the difference between the external sensor and the internal sensor
axes[1].plot(indx1, diff1, linewidth= 0.4, marker= ".")
axes[1].plot([0, indx1[len(indx1)-1]], [0, 0], linewidth= 1, color= "black")

#figure 2: raw data 2
#top plot, plot the time series
fig, axes = plt.subplots(nrows=2, ncols=1, figsize=(12, 5))
axes[0].plot(indx2, raw2[:, 0], linewidth= 0.4, marker= ".")
axes[0].plot(indx2, raw2[:, 1], linewidth= 0.4, marker= ".")

#bottom plot, plot the difference between the external sensor and the internal sensor
axes[1].plot(indx2, diff2, linewidth= 0.4, marker= ".")
axes[1].plot([0, indx2[len(indx2)-1]], [0, 0], linewidth= 1, color= "black")
